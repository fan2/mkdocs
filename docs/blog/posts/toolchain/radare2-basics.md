...
Config `cfg.bigendian=false` for temporary equivalent implementation of `pfed`, `pve 1234 4`.
...
Display the result in different ways depending on the numeric base.
